...
setwd('/Users/theoandre/Dropbox/Subgroup Experiment/Git_Analyses/Experiments/v2')
...
ggsave('figs/exp1b-learning.eps', device = cairo_ps, height = 2.5, width = 5)
```
...
ggsave('figs/exp1b-similarity.eps', device = cairo_ps, height = 2.5, width = 4.5)
```
...
ggsave('figs/exp1b-kcluster.eps', device = cairo_ps, height = 2.5, width = 2.5)
```
...
ggsave('figs/exp1b-confidence.eps', device = cairo_ps, height = 2.5, width = 2.5)
```
