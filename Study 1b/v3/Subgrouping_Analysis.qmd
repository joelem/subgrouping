...
ggsave('figs/exp1c-learning.eps', device = cairo_ps, height = 2.5, width = 5)
```
...
ggsave('figs/exp1c-similarity.eps', device = cairo_ps, height = 2.5, width = 4.5)
```
...
ggsave('figs/exp1c-kcluster.eps', device = cairo_ps, height = 2.5, width = 2.5)
```
...
ggsave('figs/exp1c-confidence.eps', device = cairo_ps, height = 2.5, width = 2.5)
```
